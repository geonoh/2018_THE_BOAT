...
static const LPTSTR	CLASS_NAME = TEXT("D3D12OnFBX2016Sample");	// ウィンドウネ??
...
VertexDataArray				g_vertexDataArray;									// 頂?デ??配列(読み込み保存用)
...
bool setupResource()
{
	...
	{
		// FBXモデル読み込み
		if(LoadFBXConvertToVertexData("../datas/Soldier.fbx", g_vertexDataArray) == false)
		{
...
void Render()
{
	...
	float clearColor[] = { 0, 0.0f, 0.0f, 0.0f };
	...
	static XMFLOAT3 rotation(0, 0, 180);
