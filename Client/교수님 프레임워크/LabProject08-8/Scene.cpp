...
#else
	m_pTerrain = new CHeightMapTerrain(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, _T("../Assets/Image/Terrain/terrain18.raw"), 513, 513, 513, 513, xmf3Scale, xmf4Color);
#endif
...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pd3dDescriptorRanges[5].BaseShaderRegister = 4; //t4: Texture[6]
