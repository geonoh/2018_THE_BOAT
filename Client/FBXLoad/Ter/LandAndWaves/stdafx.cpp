...
//// LabProject14.pch는 미리 컴파일된 헤더가 됩니다.
...
//
//	D3D12_HEAP_PROPERTIES d3dHeapPropertiesDesc; ::ZeroMemory(&d3dHeapPropertiesDesc, sizeof(D3D12_HEAP_PROPERTIES));
//	d3dHeapPropertiesDesc.Type = d3dHeapType; d3dHeapPropertiesDesc.CPUPageProperty = D3D12_CPU_PAGE_PROPERTY_UNKNOWN;
//	d3dHeapPropertiesDesc.MemoryPoolPreference = D3D12_MEMORY_POOL_UNKNOWN;
//	d3dHeapPropertiesDesc.CreationNodeMask = 1;
//	d3dHeapPropertiesDesc.VisibleNodeMask = 1;
//
//	D3D12_RESOURCE_DESC d3dResourceDesc; ::ZeroMemory(&d3dResourceDesc, sizeof(D3D12_RESOURCE_DESC));
//	d3dResourceDesc.Dimension = D3D12_RESOURCE_DIMENSION_BUFFER; d3dResourceDesc.Alignment = 0;
...
//				(*ppd3dUploadBuffer)->Map(0, &d3dReadRange, (void **)&pBufferDataBegin); memcpy(pBufferDataBegin, pData, nBytes);
