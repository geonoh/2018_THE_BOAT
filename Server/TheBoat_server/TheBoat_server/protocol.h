...
// Server To Server
#define SS_COLLISION			9
#define SS_PLAYER_POS_UPDATE	10
#define SS_BULLET_GENERATE		11
#define SS_BULLET_UPDATE		12
#define SS_PLAYER_READY			13
#define SS_PLAYER_MOVE			14
#define SS_ITEM_GEN				15	// Event
